					...
					case $opc5 in
							1 )	echo
								read -p "[*] Escribe la Ip de Red (Ej: 192.168.1.0 o 192.168.0.0): " IpRed
								 gnome-terminal --geometry 80x54+1300+20 -- bash -c "sudo netdiscover -r $IpRed/24; sleep 9999999999;" &
								read -p "[*] Escribe la Ip que desea escanear (Ej: 192.168.1.43 o 192.168.1.0/24): " Ip
								 pkill gnome-terminal
								 gnome-terminal --geometry 80x24+1300+20 -- bash -c "sudo nmap -top-ports 1000 -Pn $Ip; sleep 9999999999;" &
